    ...
    <div class="bottom-box">
      ...
      <div class="table-container" v-if="isTable == 2">
        ...
        <div class="signlist">
          <div class="signlist-item">
            ...
            <div class="clearfix">
              <span class="imgPdf fl" @click="onPreviewfile()">
                <svg-icon icon-class="PDFtubiao"></svg-icon>
              </span>
              <div>
                <p class="pdfname"  @click="onPreviewfile()">xxx.pdf</p>
      ...
      <div class="table-container" v-if="isTable == 3">
        ...
        <el-button-group>
          ...
          <el-button type="text" icon="el-icon-menu" @click="download()">模板下载</el-button>
          <el-button type="text" icon="el-icon-upload2" @click="upload()">导入</el-button>
          <el-button type="text" icon="el-icon-check" @click="submit()">提交</el-button>
          <el-button type="text" icon="el-icon-refresh" @click="reback()">撤回</el-button>
          <el-button type="text" icon="el-icon-download" @click="downloadpdf()">下载</el-button>
          <el-button type="text" icon="el-icon-printer" @click="onPrint()">打印</el-button>
        </el-button-group>
        <div class="signlist">
